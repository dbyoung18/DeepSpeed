...
class GPTJInferenceModel(DSTransformerModelBase):
    """
    Inference model implementation for ragged batching for GPT-J models.
    """

    _non_transformer: Optional[GPTJNonTransformerContainer]
    """
    Embed + unembed container. Specializing the type annotation.
    """

    _transformer: Optional[Iterable[GPTJTransformerContainer]]
    """
    ...
    def activation_dtype(self) -> DtypeEnum:
        ...
        elif self._config.torch_dtype == torch.float32:
            return DtypeEnum.fp32
        else:
            raise NotImplementedError("Only fp16, bf16 and fp32 are supported")

    @property
    def mlp_activation_fn(self) -> ActivationType:
        activation = self._config.activation_function.lower()
    ...
    def positional_embedding_config(self) -> Optional[RotateHalfConfig]:
        return RotateHalfConfig()  # TODO: check
